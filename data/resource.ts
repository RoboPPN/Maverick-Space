...
export const resourceData: ResourceCategory[] = [
  ...
  },
  {
    ...
    resources: [
      ...
      {
        name: 'bilibili视频下载',
        desc: '该网站可下载bilibili视频',
        logo: '/img/resource/贝贝.jpg',
        href: 'https://xbeibeix.com/api/bilibili/',
      },
    ],
  },
  {
    ...
    resources: [
      {
        ...
        desc: '发现科学知识并与科学世界保持联系',
        logo: '/img/resource/ResearchGate.ico',
        href: 'https://www.researchgate.net/',
      },
      {
        name: '中国知网',
        desc: '',
        logo: '/img/resource/中国知网.ico',
        href: 'https://www.cnki.net/',
      },
      {
        name: 'Google学术镜像',
        desc: '',
        logo: '/img/resource/google学术镜像.ico',
        href: 'http://scholar.scqylaw.com/',
      },
      {
        name: 'arxiv',
        desc: '',
        logo: '/img/resource/arxiv.ico',
